...
type scapeGoatTreeNode[T constraints.Integer | constraints.Float] struct {
	value  T
...
func newScapeGoatTreeNode[T constraints.Integer | constraints.Float](value T) *scapeGoatTreeNode[T] {
